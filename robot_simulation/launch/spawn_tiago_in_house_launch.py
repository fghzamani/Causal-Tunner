...
def generate_launch_description():
    ...
    # )
    world = os.path.join(get_package_share_directory('plasys_house_world'), 'worlds','plasys_house', 'KRR_Course_Small_house.world') 
    ...
    tiago_spawn = include_launch_py_description(
        ...
        launch_arguments={'use_sim_time': 'True', 'x_pose': x_pose, 'y_pose': y_pose, 'yaw_pose': yaw_pose, 'robot_name':'tiago', 'laser_model':'sick-571' }.items()) #'arm':['left-arm'], 'arm_type':'no-arm'
