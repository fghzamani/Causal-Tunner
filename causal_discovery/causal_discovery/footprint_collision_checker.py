...
class FootprintCollisionChecker:
    ...
    def worldToMapValidated(self, wx: float, wy: float):
        ...
        # Check if world coords are below the costmap's origin
    ...
    def pointCost(self, x: int, y: int):
        ...
        return self.costmap_.map.data[self.map_data_['size_in_cell_x']*y + x] # self.costmap_.getCostXY(x, y)
    ...
    def setCostmap(self, costmap: PyCostmap2D):
        ...
        # map_resolution = costmap  # Map resolution in meters/pixel
        # map_origin = (
        #     -6.01,
        #     -5.01,
