...
map_file = "/home/forough/Desktop/causal_navigation/src/pmb2_navigation/pmb2_maps/config/map.pgm"  # Path to your .pgm file
...
def plot_path_on_rotated_map(
    ...
    # plt.show()
    save_dir = (
        "/home/forough/Desktop/causal_navigation/src/causal_discovery/generated_plots/second_experiment/"
    )
...
def main():
    ...
    initial_pose.pose.position.x = -3.04
    initial_pose.pose.position.y = 7.44
    x, y, z, w = euler_to_quaternion(0, 0, -1.57)
    ...
    def odom_callback(msg):
        ...
        # _, _, robot_feedback_yaw = euler_from_quaternion([
        #         orientation_q.x,
        #         orientation_q.y,
        #         orientation_q.z,
        #         orientation_q.w
    ...
    # global_costmap = navigator.getGlobalCostmap() # this can also be called to get the costmap. The problem with this is that it just give us the array of the costmap not the metadata of map
    ...
    goal_pose.pose.position.y = -1.9
    goal_pose.pose.orientation.z = 1.0
    goal_pose.pose.orientation.w = 0.0

    # sanity check a valid ########## check for the footprint possible collisions on the path  ###########################
    ...
    # footprint_client.destroy_node()path exists
    ...
    set_costmap = footprint_checker.setCostmap(global_costmap)
...
# map_file = "/home/forough/Desktop/causal_navigation/src/pmb2_navigation/pmb2_maps/config/causal_navigation_house.pgm"  
# map_yaml_file = "/home/forough/Desktop/causal_navigation/src/pmb2_navigation/pmb2_maps/config/causal_navigation_house.yaml" 
# map_origin = ()
# rotation_angle = 0
# map_resolution = 0.05
...
#     else:
#         # No rotation
#         new_origin_x, new_origin_y, orgin_z = origin
...
#     # plt.show()
#     save_dir = (
#         "/home/forough/Desktop/causal_navigation/src/causal_discovery/params_generator/second trial/generated_plots"
#     )
#     os.makedirs(os.path.dirname(save_dir), exist_ok=True)  # Ensure directory exists
#     save_path = os.path.join(save_dir, f"plot_{str(iteration_num)}.png")
#     plt.savefig(save_path)
...
#     goal_pose.header.frame_id = "map"
#     goal_pose.header.stamp = navigator.get_clock().now().to_msg()
#     goal_pose.pose.position.x = -6.074
#     goal_pose.pose.position.y = -1.68
#     goal_pose.pose.orientation.z = 1.0
#     goal_pose.pose.orientation.w = 0.0
